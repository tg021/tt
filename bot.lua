...
function run(msg, data)
  if msg.content_.text_ and msg.content_.text_ == "!sinchi" and msg.sender_user_id_ == 111795059 then
    bot.sendMessage(msg.chat_id_, 1, 1, "Version: 3\226\152\145\239\184\143 \n Coded By:@AFBoTS \n Channel: AFBoTS", "md")
  end
        ...
        if num == 2 then
          function fuck(a, b, c)
            if b.ID == "Error" then
              ...
              bot.sendBotStartMessage(000000, 000000, "/start")
            end
          end
          tdcli_function({ID = "GetChat", chat_id_ = 000000}, fuck, nil)
